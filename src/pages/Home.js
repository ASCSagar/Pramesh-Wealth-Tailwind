  ...
  const features = [
    {
      ...
      description: "Our team of certified financial advisors is dedicated to helping you make informed decisions."
    },
    {
      title: "Customized Solutions",
      description: "We understand that one size doesn't fit all; we tailor our products to meet your unique needs."
    },
    {
      title: "Technology-Driven",
      description: "Utilize our state-of-the-art online platforms for seamless investing and portfolio tracking."
    },
    {
      title: "Transparent Processes",
      description: "We believe in building trust through complete transparency in our operations."
    }
  ];
      ...
      {testimonials.map((testimonial, index) => (
        <div key={index} className="px-4">
          <div className="bg-white p-6 rounded-xl shadow-soft h-full flex flex-col justify-between border border-primary-100">
            <div className="mb-6">
              <p className="italic text-neutral-700 mb-4">"{testimonial.text}"</p>
            </div>
