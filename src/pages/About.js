...
import { History, Target, Users, Award, Heart, ChevronDown, ChevronUp, ArrowRight } from 'lucide-react';
      ...
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-soft p-6">
            <h3 className="text-2xl font-semibold text-primary-800 mb-6">Company Timeline</h3>
            <CompanyHistory />
          </div>

          {/* Story and Approach Column */}
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-soft p-6">
              <h3 className="text-2xl font-semibold text-primary-800 mb-6">Our Story</h3>
