...
const historyPoints = [
  {
    ...
    description:
      "Pramesh Wealth was established with a vision to provide comprehensive financial services.",
  },
  {
    year: "2005",
  ...
  },
  {
    ...
    description:
      "Expanded our presence across Gujarat with multiple branch offices.",
  },
  {
    year: "2015",
    title: "Digital Transformation",
    description:
      "Launched digital platforms for seamless client service and portfolio management.",
  },
  {
    year: "2018",
    title: "5000+ Client Milestone",
    description:
      "Achieved a significant milestone of serving over 5000 satisfied investors.",
  },
  {
    year: "2020",
  ...
  },
  {
    ...
    description:
      "Became one of the leading financial services providers in Gujarat with 5+ branches.",
  },
];
